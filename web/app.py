...
# ──────────────────────────────────────────────────────────
# === MODEL CONFIGURATION ===
MODEL_URL = "https://github.com/get543/Deepfake_Detection_Project/releases/latest/download/best_deepfake_model_ff_xception.keras"
# Local cache path (inside your app's working directory)
LOCAL_MODEL_PATH = Path("models") / "best_deepfake_model_ff_xception_87.keras"
IMG_SIZE        = (224, 224)
FRAMES_TO_SAMPLE = 30
